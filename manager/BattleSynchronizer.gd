...
func set_progress_bars() -> void:
	for p_id in GameManager.players:
		...
		if (
			...
			if GameManager.players[GameManager.ai_player_id]["NPCID"] not in OverworldManager.defeated_npc_ids:
				OverworldManager.defeated_npc_ids.append(GameManager.players[GameManager.ai_player_id]["NPCID"])
