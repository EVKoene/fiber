...
@onready var battle_stat_container_scene := preload("res://card/card_assets/BattleStatsContainer.tscn")
...
func flip_card() -> void:
	...
	battle_stats.battle_stats_container.size_flags_vertical = SIZE_SHRINK_BEGIN
