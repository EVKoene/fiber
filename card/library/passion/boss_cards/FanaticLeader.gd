...
func _init() -> void:
	boss_abilities = {
		...
		1: {
			"WeightFactor": 3,
			"Func": "deal_1_damage_to_all_in_range_3",
...
func create_3_followers() -> String:
	...
	return "Create up to 3 Fanatic Followers in adjacent playspaces and exhaust"


func deal_1_damage_to_all_in_range_3() -> String:
	if len(GameManager.cards_in_play[GameManager.opposing_player_id(card_owner_id)]) == 0:
		return "Deal 1 damage to each unit in a range of 3"
...
func deal_3_damage_to_closest() -> String:
	if len(GameManager.cards_in_play[GameManager.opposing_player_id(card_owner_id)]) == 0:
		return "Deal 1 damage to the closest enemy unit"
...
func create_1_berserker() -> String:
	var ps_options := []
	for ps in current_play_space.adjacent_play_spaces():
		if !ps.card_in_this_play_space:
	...
	return "Create 1 Warthog Berserker in an adjacent playspace"

func create_2_berserkers() -> String:
	...
	return "Create 2 Warthog Berserkers in adjacent playspaces"


func create_2_cheetahs() -> String:
