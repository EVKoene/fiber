...
var cards_info = {
	...
	cards.IMAGINARY_FRIEND: {
		...
		"AttackRange": 1,
		"Lord": false,
		"Text": "Whenever you play a spell, increase a random stat by 1.",
		"Reminder": "Stats are max attack, min attack, min attack, health, movement and range",
		"Purposes": [],
...
cards.FLOW_ACCELERATOR: {
	...
	cards.GOBLIN_ARCHER: {
		...
		"Lord": false,
		"Text": "",
		"Purposes": [Collections.purposes.RANGED_BATTLE],
		"IMGPath": "res://assets/card_images/growth/GoblinArcher.png",
	},
