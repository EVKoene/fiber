...
func setup_npcs() -> void:
	$BusinessPersonLeonardo.setup_npc(NPCDatabase.npcs.BUSINESS_PERSON_LEONARDO, Collections.directions.DOWN)
	$BusinessPersonAna.setup_npc(NPCDatabase.npcs.BUSINESS_PERSON_ANA, Collections.directions.DOWN)
	$BusinessPersonJeroen.setup_npc(NPCDatabase.npcs.BUSINESS_PERSON_JEROEN, Collections.directions.DOWN)
